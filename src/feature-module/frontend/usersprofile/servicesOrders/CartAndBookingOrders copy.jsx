          ...
          <div className="row">
            ...
            >
              {ServiceTabs?.filter((item) => (item?.categoryType
                ...
                === "booking" || item?.categoryType === "rentals_addtocarts" || item?.categoryType === "all")
              ).map((service) => (
                <button
                  key={service?._id}
                  type="button"
                                ...
                                {order?.orderStatus && (
                                  <div
                                    style={{
                                      ...
                                      padding: "8px 12px",
                                      borderRadius: "8px",
                                      border: `1px solid ${order?.orderStatus === "pending"
                                        ? "#FAAD14"
                                        : order?.orderStatus === "completed"
                                          ? "#52C41A"
                                          : "#FF4D4F"
                                  ...
                                  >
                                    ...
                                    >
                                      <i
                                        className={`fa-solid ${order?.orderStatus === "pending"
                                          ? "fa-clock"
                                          : order?.orderStatus === "completed"
                                            ? "fa-circle-check"
                                            : "fa-circle-xmark"
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "8px", marginBottom: "4px" }}>
                                <p style={{ margin: 0, fontWeight: 700, fontSize: "13.5px", color: "#1e1b4b", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1 }}>
                                  {orderItem?.productSnapshot?.name?.length > 30 ? orderItem?.productSnapshot?.name.slice(0, 30) + "…" : orderItem?.productSnapshot?.name}
                                </p>
                                {status && (
