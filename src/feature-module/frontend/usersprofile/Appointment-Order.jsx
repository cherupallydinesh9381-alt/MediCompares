...
const AppoitmentsOrders = ({ HomeNavigate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataPayload.append("productdetails", productId || "");
  ...
  const grandTotal = selectedOrder?.withCouponAndWithWallet || 0;
            ...
            <div className="mb-3 position-relative">
              ...
              >
                ...
                {isMobile ? (
                  ...
                  >
                    {[
                      { id: "upcoming", label: "Upcoming Appointments", icon: "fa-calendar-alt" },
                      { id: "past", label: "Past Appointments", icon: "fa-history" },
